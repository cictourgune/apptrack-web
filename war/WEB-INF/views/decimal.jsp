...
<body>
	<div id="integer-page" data-role="page" data-dialog="true" data-close-btn="right" data-corners="false"   data-overlay-theme="a"> 
			...
			<form id="id_variable-form"
				...
				<input class="id_tipo" type="hidden" name="tipo" id="id_tipo_var" value="dec" />
				...
				<div id="div_integer" class="div_integer" style="margin-bottom: 5%">
					<label for="slider-fill">Valor min:</label> 
					<input type="text" name="slider_fill_min" id="id_slider_fill_min" data-highlight="true" /> 
				 
					<label for="slider-fill">Valor max:</label> 
					<input type="text" name="slider_fill_max" id="id_slider_fill_max" data-highlight="true" /> 
				...
				<fieldset class="ui-grid-a">
					<div class="ui-block-a">
						<a href="#" id="id_alta_var_decimal" data-role="button" 
							data-transition="none" data-icon="check" data-iconpos="right">Aceptar</a>
					</div>
					<div class="ui-block-b">
						<a href="#" id="id_altadecimal_cancel" data-rel="back"
		...
		<div id='decimal-error' data-role="content"
