...
<body>
	...
	<div id="vista-page" data-role="page" data-dom-cache="true"> 
		...
		<input type="hidden" id="idAplicacion" data-val="${aplicacion.idaplicacion}">
		...
		<div data-role="panel" id="leftmenu" data-position="left"
			...
			<ul data-role="listview" style="margin-top:37px">
				<li data-icon="false" data-theme="b"><a href="#" id="menu_mapas_visor" action="mapaDashboardVisor">Mapa</a></li>  
 				...
 				<div class="col10">
 					...
 					<ul data-role="listview" data-inset="true" data-theme="d" data-divider-theme="a"> 
							<li data-role="list-divider">
								${aplicacion.nombreaplicacion} : Número de usuarios <span id="mapa_num_usuarios"> ${numUsuarios}</span> 
							</li>
							<li>
